...
class EventCreationProvider with ChangeNotifier {
  ...
  Future<bool> createEvent({
    ...
    if (eventName.isEmpty ||
        ...
        _selectedCity == null ||
        description.isEmpty) {
      _errorMessage = "Please fill all required fields, including location.";
      _setLoading(false);
      return false;
    }
    ...
    try {
      ...
      if (finalVenueName != null && finalVenueName.isNotEmpty) {
        request.fields['venueName'] = finalVenueName;
      }
